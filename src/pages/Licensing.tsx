      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="text-center mb-6">
                <h3 className={`text-2xl font-medium text-white mb-2 ${isRTL ? 'font-arabic' : 'font-inter'}`}>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`w-full py-3 bg-gradient-to-r from-primary-600 to-accent-500 text-white font-medium rounded-lg transition-all duration-300 ${isRTL ? 'font-arabic' : 'font-inter'}`}
              >
        ...
        <div className="mb-16">
          ...
          <div className="glass-card p-8">
            <p className={`text-lg text-gray-300 font-light mb-8 text-center ${isRTL ? 'font-arabic' : 'font-inter'}`}>
              {language === 'ar'
        ...
        >
          <h2 className={`text-2xl font-medium text-white text-center mb-8 ${isRTL ? 'font-arabic' : 'font-inter'}`}>
            {language === 'ar' ? 'جاهز لترخيص تقنية الذكاء الاصطناعي المثبتة؟' : 'Ready to License Proven AI Technology?'}
          </h2>
          <p className={`text-center text-gray-300 mb-8 ${isRTL ? 'font-arabic' : 'font-inter'}`}>
