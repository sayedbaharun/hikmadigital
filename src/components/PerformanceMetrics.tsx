...
import { ArabicCalligraphy } from "./ArabicElements";
    ...
    <section id="metrics-section" className="py-20 bg-secondary/20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <ArabicCalligraphy 
            text="البيانات المباشرة من أنظمة الذكاء الاصطناعي"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16 mb-12">
          <div className="card-elegant p-8 text-center group hover:border-primary/50 transition-all duration-500">
            ...
            <div className="text-4xl md:text-5xl font-bold mb-3 text-primary">347%</div>
          ...
          <div className="card-elegant p-8 text-center group hover:border-primary/50 transition-all duration-500">
            ...
            <div className="text-4xl md:text-5xl font-bold mb-3 text-accent">500+</div>
          ...
          <div className="card-elegant p-8 text-center group hover:border-primary/50 transition-all duration-500">
            ...
            <div className="text-4xl md:text-5xl font-bold mb-3 text-primary">94.5%</div>
